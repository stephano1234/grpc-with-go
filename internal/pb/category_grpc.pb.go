...
type CategoryServiceClient interface {
	CreateCategory(ctx context.Context, in *CreateCategoryResquest, opts ...grpc.CallOption) (*CreateCategoryResponse, error)
	QueryCategory(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*QueryCategoryResponse, error)
	GetCategory(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*Category, error)
	UpdateCategory(ctx context.Context, in *Category, opts ...grpc.CallOption) (*Blank, error)
...
func (c *categoryServiceClient) CreateCategory(ctx context.Context, in *CreateCategoryResquest, opts ...grpc.CallOption) (*CreateCategoryResponse, error) {
...
func (c *categoryServiceClient) QueryCategory(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*QueryCategoryResponse, error) {
	out := new(QueryCategoryResponse)
	err := c.cc.Invoke(ctx, "/pb.CategoryService/QueryCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) UpdateCategory(ctx context.Context, in *Category, opts ...grpc.CallOption) (*Blank, error) {
	out := new(Blank)
...
type CategoryService_CreateCategoryStreamClient interface {
	Send(*CreateCategoryResquest) error
	CloseAndRecv() (*QueryCategoryResponse, error)
	grpc.ClientStream
}
...
func (x *categoryServiceCreateCategoryStreamClient) Send(m *CreateCategoryResquest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamClient) CloseAndRecv() (*QueryCategoryResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(QueryCategoryResponse)
...
func (x *categoryServiceCreateCategoryStreamBidirectionalClient) Send(m *CreateCategoryResquest) error {
	return x.ClientStream.SendMsg(m)
}
...
type CategoryServiceServer interface {
	CreateCategory(context.Context, *CreateCategoryResquest) (*CreateCategoryResponse, error)
	QueryCategory(context.Context, *Blank) (*QueryCategoryResponse, error)
	GetCategory(context.Context, *GetCategoryRequest) (*Category, error)
	UpdateCategory(context.Context, *Category) (*Blank, error)
...
func (UnimplementedCategoryServiceServer) CreateCategory(context.Context, *CreateCategoryResquest) (*CreateCategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateCategory not implemented")
}
func (UnimplementedCategoryServiceServer) QueryCategory(context.Context, *Blank) (*QueryCategoryResponse, error) {
...
func (UnimplementedCategoryServiceServer) UpdateCategory(context.Context, *Category) (*Blank, error) {
...
func _CategoryService_QueryCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Blank)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).QueryCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CategoryService/QueryCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).QueryCategory(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
...
type CategoryService_CreateCategoryStreamServer interface {
	SendAndClose(*QueryCategoryResponse) error
	Recv() (*CreateCategoryResquest, error)
	grpc.ServerStream
}
...
func (x *categoryServiceCreateCategoryStreamServer) SendAndClose(m *QueryCategoryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamServer) Recv() (*CreateCategoryResquest, error) {
	m := new(CreateCategoryResquest)
...
func (x *categoryServiceCreateCategoryStreamBidirectionalServer) Recv() (*CreateCategoryResquest, error) {
	m := new(CreateCategoryResquest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CategoryService_QueryCategory_Handler,
		},
		{
